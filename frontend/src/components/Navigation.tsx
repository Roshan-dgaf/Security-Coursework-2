    ...
    >
      <div className="max-w-[1400px] mx-auto px-2 flex h-14 items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            PAW<span className="text-blue-500">S</span>
          </span>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Cart Sheet ONLY if user is logged in */}
          {user && (
            <Sheet>
              ...
              >
                <div className="flex-1 flex flex-col overflow-hidden">
                  <div className="mb-4 border-b pb-3">
                    <h2 className="text-lg font-bold">Your Adoption Cart</h2>
                  </div>
                  <ScrollArea className="h-full pr-2">
                    <div className="flex flex-col gap-5 pb-4">
                      {cartLoading ? (
                          ...
                          <div key={cartItem.item?._id || idx} className="flex items-center gap-4">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-xs text-gray-500">
                                Breed: {cartItem.size} | Color: {cartItem.color}
                              </p>
                        ...
                        <p className="text-gray-500 text-center py-10">Your adoption cart is empty.</p>
                      )}
                    </div>
                  </ScrollArea>
                </div>
