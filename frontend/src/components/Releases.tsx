      ...
      <Tabs defaultValue="men" className="w-full">
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-6">
            ...
            <TabsList>
              <TabsTrigger value="men">Dog</TabsTrigger>
              <TabsTrigger value="women">Cat</TabsTrigger>
            </TabsList>
          </div>
        ...
        <TabsContent value="men">
          {isLoading ? (
            ...
            <div className="w-full flex justify-center py-12">
              <span className="text-gray-400 text-lg">No Dog's new arrivals.</span>
            </div>
          ) : (
        ...
        <TabsContent value="women">
          {isLoading ? (
            ...
            <div className="w-full flex justify-center py-12">
              <span className="text-gray-400 text-lg">No Cat's new arrivals.</span>
            </div>
          ) : (
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-6">
